      ...
      {showPayment && (
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-6 bg-slate-950/95 backdrop-blur-md animate-in fade-in">
          <div className="w-full max-sm overflow-hidden flex flex-col items-center">
            ...
            <div className="w-full bg-[#0b0e1a] p-10 flex flex-col items-center space-y-8 shadow-2xl"><img src="qr_code.png" alt="QR Code" onError={(e) => { (e.target as any).src = "https://api.qrserver.com/v1/create-qr-code/?size=300x300&data=Huangli_VIP_0.66"; }} className="w-60 h-60 rounded-xl bg-white p-2" /><div className="text-center"><span className="text-5xl font-bold text-white tracking-tight">¥ 0.66</span></div></div>
