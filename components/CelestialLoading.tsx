  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-[#020617] overflow-hidden">
      ...
      <div className="relative w-[500px] h-[500px] flex items-center justify-center scale-90 md:scale-110">
        ...
        {/* 月亮轨道 */}
        <div className="absolute w-[280px] h-[280px] border border-slate-600/20 rounded-full animate-[spin_25s_linear_infinite]">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4">
            <div className="w-full h-full bg-slate-300 rounded-full shadow-[0_0_10px_rgba(148,163,184,0.6)] animate-pulse"></div>
            <div className="absolute inset-0 bg-white rounded-full scale-75 opacity-80"></div>
          </div>
        </div>

        {/* 地球轨道 */}
        <div className="absolute w-[380px] h-[380px] border border-blue-500/15 rounded-full animate-[spin_40s_linear_reverse_infinite]">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-5 h-5">
            <div className="w-full h-full bg-blue-500 rounded-full shadow-[0_0_15px_rgba(59,130,246,0.8)] animate-pulse"></div>
            <div className="absolute inset-0 bg-white rounded-full scale-60 opacity-60"></div>
          </div>
        </div>
      ...
      <style>{`
        ...
        @keyframes spin_25s_linear_infinite {
          from { transform: rotate(0deg); }
          to { transform: rotate(360deg); }
        }
        @keyframes spin_40s_linear_reverse_infinite {
