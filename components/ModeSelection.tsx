...
import { Sparkles, Sun, Moon, CalendarDays, RotateCcw, Settings } from 'lucide-react';
...
const ModeSelection: React.FC<ModeSelectionProps> = ({ onSelect, onToggleTheme, theme, onResetProfile, onProfileSettings }) => {
  return (
      ...
      <div className="absolute top-6 right-6 flex gap-2">
        ...
        {onResetProfile && (
          <button 
            ...
            className="p-3 rounded-full bg-white/50 dark:bg-slate-900/50 backdrop-blur-md border border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 hover:text-red-500 dark:hover:text-red-400 transition-all shadow-sm"
            title="重置画像设置"
          >
            <RotateCcw size={20} />
          </button>
