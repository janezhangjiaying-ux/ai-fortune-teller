...
const UserInfoForm: React.FC<UserInfoFormProps> = ({ onSubmit, defaultBirthDate }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-lg mx-auto bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-200 dark:border-slate-800 p-8 rounded-3xl shadow-xl dark:shadow-2xl space-y-6 transition-all duration-500 hover:shadow-2xl hover:shadow-indigo-500/10">
